export default function Home({ width, height, fill = false }) {
  if (fill) {
    return (
      <svg viewBox="0 0 24 24" width={width} height={height} ariaHidden="true" fill="currentColor">
        <g>
  ...
  return (
    <svg viewBox="0 0 24 24" width={width} height={height} ariaHidden="true">
      <g>
